...
class ControlFiles():
    ...
    def __init__(self, inputPath, control_file = 'TCA_input.xml', TCA_version = 'standalone' ):
    ...
    def Load_Control(self):
        ...
        if self.control_values["OutputLevel"][0] !=0:
            ...
            logger.info("TCA Version 2.1 by Noblis: February 2014")
    ...
    def Create_input_summary_file(self, file_name='TCA_Input_Summary.csv'):
         with open(self.filePath + file_name, 'wb') as f_out:
