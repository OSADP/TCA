...
#-------------------------------------------------------------------------
    ...
    def CheckMessage(self, veh, tp):
        ...
        if (veh['last_CAM_speed'] is not None) and \
        ...
        if veh['heading'] is not None:
            if veh['last_CAM_heading'] is not None and (abs(((veh['last_CAM_heading'] - veh['heading'] + 180) % 360) - 180) > 4):
                return True
    ...
    def GenerateTransmit(self, veh_data, transTo, tp):
        ...
        if veh_data['CAM_equipped']:
            ...
            CAM = {
                ...
                'yawRateConfidence' : 8,
                'vehicleLengthValue' : veh_data['length'],
                'vehicleLengthConfidence' : 3,
                'vehicleWidth' : veh_data['width'],
            }
