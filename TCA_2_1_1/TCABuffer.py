        ...
        if type == 1:
            ...
            #Every other one plus keep first and last IDs
                ...
                while 1 == 1:
                    ...
                    #print "1st Pointer=%s Len=%s" %  (self.ActiveBuffers[vehicleID]['pointer'],len(self.ActiveBuffers[vehicleID]['periodic']))
                    ...
                    if len(self.ActiveBuffers[vehicleID]['periodic']) != 1:
                        ...
                        #print "2nd perSS=%s nextSS=%s   Pointer=%s Len=%s" %  (perSS,nextSS,self.ActiveBuffers[vehicleID]['pointer'],len(self.ActiveBuffers[vehicleID]['periodic']))
            ...
            #Every other one plus keep last snapshot
                ...
                if len(self.ActiveBuffers[vehicleID]['periodic']) != 1:
                        ...
                        #print "1st Pointer=%s Len=%s halfway = %d" %  (self.ActiveBuffers[vehicleID]['pointer'],len(self.ActiveBuffers[vehicleID]['periodic']),len(self.ActiveBuffers[vehicleID]['periodic'])/2)
